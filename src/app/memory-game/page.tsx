...
export default function MemoryGame() {
  ...
  const Modalities: ModalityOption[] = [
    { name: "easy", isActive: false },
    { name: "medium", isActive: false },
    { name: "hard", isActive: false },
    { name: "impossible", isActive: false },
  ];

  const MatchStatuses: MatchStatusOption[] = [
    { name: "progress", isActive: false },
    { name: "win", isActive: false },
    { name: "lose", isActive: false },
  ];
